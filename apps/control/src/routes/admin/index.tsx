      ...
      <div class="flex mt-4 gap-4">
        ...
        <div class="p-4 px-6 rounded-lg bg-card border flex-1">
          <p class="text-sm text-muted-foreground mb-2">
            Query Results (last 24h)
          </p>

          <div class="flex">
            <p>NOERROR</p>
            <p class="ml-auto">
              {overview()?.rcodeRows.filter((r) => r.rcode === "NOERROR")[0]
                ?.total || 0}
            </p>
          </div>
          ...
          <div class="flex">
            <p>FORMERR</p>
            <p class="ml-auto">
              {overview()?.rcodeRows.filter((r) => r.rcode === "FORMERR")[0]
                ?.total || 0}
            </p>
          </div>
          ...
          <div class="flex">
            <p>SERVFAIL</p>
            <p class="ml-auto">
              {overview()?.rcodeRows.filter((r) => r.rcode === "SERVFAIL")[0]
                ?.total || 0}
            </p>
          </div>
          ...
          <div class="flex">
            <p>NXDOMAIN</p>
            <p class="ml-auto">
              {overview()?.rcodeRows.filter((r) => r.rcode === "NXDOMAIN")[0]
                ?.total || 0}
            </p>
          </div>
          ...
          <div class="flex">
            <p>NOTIMP</p>
            <p class="ml-auto">
              {overview()?.rcodeRows.filter((r) => r.rcode === "NOTIMP")[0]
                ?.total || 0}
            </p>
          </div>
          ...
          <div class="flex">
            <p>REFUSED</p>
            <p class="ml-auto">
              {overview()?.rcodeRows.filter((r) => r.rcode === "REFUSED")[0]
                ?.total || 0}
            </p>
          </div>
        </div>
